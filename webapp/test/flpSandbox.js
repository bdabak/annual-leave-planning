		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comthyuxannualleaveplanning-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comthyuxannualleaveplanning-display": {
								"semanticObject": "comthyuxannualleaveplanning",
								"action": "display",
								"description": "Plan Annual Leave",
								"title": "Plan Annual Leave",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.thy.ux.annualleaveplanning",
									"url": sap.ui.require.toUrl("com/thy/ux/annualleaveplanning")
								}
							}
						}
					}
