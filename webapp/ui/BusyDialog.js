...
sap.ui.define(
  ...
  function (
     ...
     * <ul>
     * <li>The screen is not supposed to be blocked. Use a {@link com.thy.ux.annualleaveplanning.ui.BusyIndicator} for the specific application part.</li>
     ...
     *
     * @public
     * @alias com.thy.ux.annualleaveplanning.ui.BusyDialog
     */
    var BusyDialog = Control.extend(
      "com.thy.ux.annualleaveplanning.ui.BusyDialog",
      /** @lends com.thy.ux.annualleaveplanning.ui.BusyDialog.prototype */ {
        metadata: {
          library: "com.thy.ux.annualleaveplanning.ui",
          properties: {
            /**
    ...
    BusyDialog.prototype.init = function () {
      ...
      jQuery.sap.includeStyleSheet(sLibraryPath + "/ui/css/BusyDialog.css");
      ...
      this._oDialog.addEventDelegate(
        {
          onBeforeRendering: function () {
            var text = this.getText(),
              title = this.getTitle(),
              showCancelButton =
                this.getShowCancelButton() || this.getCancelButtonText();
    ...
    BusyDialog.prototype._fnCloseHandler = function () {
      ...
      this.fireClose({
        cancelPressed: this._isClosedFromUserInteraction || false,
      });
    };
    ...
    BusyDialog.prototype.setText = function (sText) {
      ...
      if (!this._oLabel) {
        if (sText) {
          this._oLabel = new Label(this.getId() + "-TextLabel", {
            text: sText,
          }).addStyleClass("sapMBusyDialogLabel");
     ...
     * @returns {this} BusyDialog reference for chaining.
     */
    BusyDialog.prototype.setCustomIconDensityAware = function (
      bIsDensityAware
    ) {
    ...
    BusyDialog.prototype._getCancelButton = function () {
      ...
      cancelButtonText = cancelButtonText
        ...
        : Core.getLibraryResourceBundle("sap.m").getText(
            "BUSYDIALOG_CANCELBUTTON_TEXT"
          );

      // eslint-disable-next-line no-return-assign
      return this._cancelButton
        ? this._cancelButton
        : (this._cancelButton = new Button(this.getId() + "busyCancelBtn", {
